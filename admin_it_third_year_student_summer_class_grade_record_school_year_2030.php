...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM third_year_it_summer_class_student_record_school_year_2030") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2030 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 150px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2025.php">2025</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2026.php">2026</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2027.php">2027</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2028.php">2028</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2029.php">2029</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2030.php">2030</option>
                            </select>
                        </div>
                        
                        <div style="float: right; margin-right: 60%; width: 250px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                <option value="" hidden disable>Semester/Summer Class</option>
                                <option value="admin_it_third_year_student_grade_year_2025.php">1 Semester</option>
                                <option value="admin_it_third_year_student_second_sem_grade_record_school_year_2025.php">2 Semester</option>
                                <option value="admin_it_third_year_student_summer_class_grade_record_school_year_2025.php">Summer Class</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <table>
                            <thead>
                                <tr >
                                    <th colspan="5"><center>Summer Class</center></th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2030 WHERE 
                                    third_year_student_name_summer_class LIKE '%$search%' OR
                                    third_year_student_grade_summer_class_status LIKE '%$search%' OR 
                                    third_year_student_id_summer_class LIKE '%$search%'";

                                $result = mysqli_query($link, $query);

                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($row['third_year_student_id_summer_class']); ?></td>
                                        <td><?php echo htmlspecialchars($row['third_year_student_name_summer_class']); ?></td>
                                        <td><?php echo htmlspecialchars($row['third_year_student_grade_summer_class_status']); ?></td>
                                        <td>
                                            <form action="it_update_third_year_summer_class_student_grade_status_school_year_2030.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="third_year_student_grade_summer_class_status" class="status-select" onchange="this.form.submit()">
                                                    <option value="Not Completed" <?php echo ($row['third_year_student_grade_summer_class_status'] === 'Not Completed') ? 'selected' : ''; ?>>Not Completed</option>
                                                    <option value="Completed" <?php echo ($row['third_year_student_grade_summer_class_status'] === 'Completed') ? 'selected' : ''; ?>>Completed</option>
                                                </select>
                                            </form>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['third_year_student_id_summer_class']); ?>', '<?php echo htmlspecialchars($row['third_year_student_name_summer_class']); ?>')">Edit</a>
                                            <a href="javascript:void(0)" onclick="openDeleteModal('<?php echo htmlspecialchars($row['third_year_student_id_summer_class']); ?>')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2030 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            <h2>Edit Third Year Student Information </h2>
                            <form id="editRentTogaForm" method="POST" action="it_update_summer_class_student_info_school_year_2030.php">
                                <input type="hidden" id="modal_id" name="id">
                                <label for="first_year_student_id">Student ID</label>
                                <input type="text" id="modal_third_year_student_id_summer_class" name="third_year_student_id_summer_class" required><br>
                                <label for="student_name">Student Name</label>
                                <input type="text" id="modal_third_year_student_name_summer_class" name="third_year_student_name_summer_class" required><br>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_summer_class_delete_student_school_year_2030.php" method="POST">
                                <input type="hidden" id="third_year_student_id_summer_class" name="third_year_student_id_summer_class">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_record_summer_class_function_school_year_2030.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                                    <label for="student_name">Student ID</label>
                                    <input type="text" name="third_year_student_id_summer_class" id="third_year_student_id_summer_class" required>

                                    <label for="student_name">Student Name</label>
                                    <input type="text" name="third_year_student_name_summer_class" id="third_year_student_name_summer_class" required>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Information Technology Summer Class Grade Record School Year 2030</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2030";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                            <td>" . $row["third_year_student_id_summer_class"]. "</td>
                                            <td>" . $row["third_year_student_name_summer_class"]. "</td>
                                            <td>" . $row["third_year_student_grade_summer_class_status"]. "</td>
                                        </tr>";
                                }
                                echo "</table>";
                            } else {
...
function openModal(id, studentId, Firstsem) {
    ...
    document.getElementById('modal_third_year_student_id_summer_class').value = studentId;
    document.getElementById('modal_third_year_student_name_summer_class').value = Firstsem;
}
...
function openDeleteModal(third_year_student_id_summer_class) {
    document.getElementById('third_year_student_id_summer_class').value = third_year_student_id_summer_class;
