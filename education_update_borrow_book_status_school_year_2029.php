...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $borrow_book_status) {
        ...
        $sql = 'UPDATE education_student_library_borrow_year_2029 SET borrow_book_status = :borrow_book_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_student_library_borrow_year_2029.php"); // Adjust to your main page
        } else {
