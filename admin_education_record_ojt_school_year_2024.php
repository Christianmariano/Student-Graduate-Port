        ...
        <div class="main">
            <div class="topbar">
                ...
                <div class="user">
                    ...
                    <div class="dropdown-content_a">
                        ...
                        <a href="admin_educationr_change_password.php">Change Password</a>
                    </div>
                </div>
            </div>
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>OJT Record School Year 2024-2025</h2>
                            <!-- Search Form -->
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="education_update_ojt_status_school_year_2030.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="ojt_status" class="status-select" onchange="this.form.submit()">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        ...
                        <h2>Edit Student Information</h2>
                            <form id="editRentTogaForm" method="POST" action="education_update_ojt_info_school_year_2030.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="education_ojt_fee_delete_student_school_year_2030.php" method="POST">
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_record_OJT_function_school_year_2030.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="file-list">
                 ...
                 <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student OJT Record School Year 2024-2025</p>
                        <br>
                    </div>
