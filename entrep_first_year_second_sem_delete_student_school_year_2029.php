...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['first_year_student_id_second_sem'])) {
    ...
    $query = "DELETE FROM first_year_entrep_second_sem_student_record_school_year_2029 WHERE first_year_student_id_second_sem = '$first_year_student_id_second_sem'";
