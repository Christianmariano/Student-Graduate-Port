...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['second_year_student_id'])) {
    ...
    $query = "DELETE FROM second_year_entrep_first_sem_student_record_school_year_2029 WHERE second_year_student_id = '$second_year_student_id'";

    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_entrep_second_year_student_grade_record_school_year_2029.php'); // Adjust as necessary
        exit;
    } else {
