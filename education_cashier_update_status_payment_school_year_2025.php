...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $payment_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2025 SET payment_status = :payment_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_cashier_education_department_record_borrow_toga_school_year_2025.php"); // Adjust to your main page
        } else {
