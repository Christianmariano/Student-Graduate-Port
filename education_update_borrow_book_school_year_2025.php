...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($student_id)) {
        ...
        $currentStudentIdQuery = "SELECT student_id FROM education_student_library_borrow_year_2025 WHERE id = '$id'";
    ...
    if (!empty($student_name)) {
        ...
        $currentStudentNameQuery = "SELECT student_name FROM education_student_library_borrow_year_2025 WHERE id = '$id'";
    ...
    $query = "UPDATE education_student_library_borrow_year_2025 SET $updateString WHERE id = '$id'";
