            ...
            <div class="details">
                ...
                <div class="form-container">
                    <div style="background-color: whitesmoke; color: margin-bottom:5% black; height: 35%;">
                        <form action="Fisheries_add_event.php" method="POST" >
                            <center>
                    ...
                    <div style="background-color: whitesmoke; color: black; margin-bottom:5%; height: 25%;">
                        <form action="Fisheries_update_event_title.php" method="POST" style="margin-top: 20px;">
                            <center>
                    ...
                    <div style="background-color: whitesmoke; color: margin-bottom:5% black; height: 33%;">
                        <form action="Fisheries_update_event_date.php" method="POST" style="margin-top: 20px;">
                            <center>
                    ...
                    <div style="background-color: whitesmoke; color: black; height: 15%;">
                        <form action="Fisheries_delete_event.php" method="POST" style="margin-top: 15px;">
                            <center> 
