...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT student_name FROM guild_math_2030  WHERE student_name = '$student_name'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>window.location.href = "admin_guild_math_year_2024.php";</script>';
    } else {
        // Insert data into the database
        $sql = "INSERT INTO guild_math_2030 (year, student_name, section) 
