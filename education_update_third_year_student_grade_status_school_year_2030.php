...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $third_year_student_grade_first_sem_status) {
        ...
        $sql = 'UPDATE third_year_education_first_sem_student_record_school_year_2030 SET third_year_student_grade_first_sem_status = :third_year_student_grade_first_sem_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_third_year_student_grade_year_2030.php"); // Adjust to your main page
        } else {
