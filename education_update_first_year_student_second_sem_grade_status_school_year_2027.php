...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $first_year_student_grade_second_sem_status) {
        ...
        $sql = 'UPDATE first_year_education_second_sem_student_record_school_year_2027 SET first_year_student_grade_second_sem_status = :first_year_student_grade_second_sem_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_firt_year_student_second_sem_grade_record_school_year_2027.php"); // Adjust to your main page
        } else {
