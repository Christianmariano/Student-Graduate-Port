...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT second_year_student_id FROM second_year_entrep_first_sem_student_record_school_year_2025  WHERE second_year_student_id = '$second_year_student_id'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>window.location.href = "admin_entrep_second_year_student_grade_record_school_year_2025.php";</script>';
    } else {
        // Insert data into the database
        $sql = "INSERT INTO second_year_entrep_first_sem_student_record_school_year_2025 (second_year_student_id, second_year_student_name) 
