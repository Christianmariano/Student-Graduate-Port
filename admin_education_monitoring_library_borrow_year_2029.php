                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_education_monitoring_library_borrow_year_2024.php">2024-2025</option>
                                <option value="admin_education_monitoring_library_borrow_year_2025.php">2025-2026</option>
                                <option value="admin_education_monitoring_library_borrow_year_2026.php">2026-2027</option>
                                <option value="admin_education_monitoring_library_borrow_year_2027.php">2027-2028</option>
                                <option value="admin_education_monitoring_library_borrow_year_2028.php">2028-2027</option>
                                <option value="admin_education_monitoring_library_borrow_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
