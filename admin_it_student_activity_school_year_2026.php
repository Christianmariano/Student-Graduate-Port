...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM it_student_activity_attendance_school_year_2026") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM it_student_activity_attendance_school_year_2026 LIMIT $offset, $total_record_per_page";
// Result
        ...
        <div class="main">
            ...
            <div class="details">
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_it_student_activity_school_year_2024.php">2024-2025</option>
                                <option value="admin_it_student_activity_school_year_2025.php">2025-2026</option>
                                <option value="admin_it_student_activity_school_year_2026.php">2026-2027</option>
                                <option value="admin_it_student_activity_school_year_2027.php">2027-2028</option>
                                <option value="admin_it_student_activity_school_year_2028.php">2028-2029</option>
                                <option value="admin_it_student_activity_school_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = "SELECT * FROM it_student_activity_attendance_school_year_2026 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_student_activity_year_2026.php" method="POST" style="display: inline;">
                                        ...
                                        <td>
                                            <form action="it_update_student_activity_uswag_year_2026.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                        ...
                                        <td>
                                            <form action="it_update_student_activity_christmass_party_year_2026.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                        ...
                                        <td>
                                            <form action="it_update_student_activity_status_year_2026.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['student_id']); ?>', '<?php echo htmlspecialchars($row['fullname']); ?>', '<?php echo htmlspecialchars($row['year_level']); ?>')">Edit</a>
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM it_student_activity_attendance_school_year_2026 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_student_activity_info_year_2026.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_student_activity_delete_student_school_year_2026.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_student_activity_year_2026.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Student Activity Attendance Record School Year 2026-2027</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM it_student_activity_attendance_school_year_2026";
