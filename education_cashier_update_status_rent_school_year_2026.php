...
if (!empty($id) && in_array($rent_status, ['Receive', 'Return', ''])) {
    ...
    $check_sql = "SELECT rent_status FROM education_student_record_school_year_2026 WHERE id = ?";
    ...
    if ($stmt) {
        ...
        if ($current_status == 'Submit') {
            ...
            $update_sql = "UPDATE education_student_record_school_year_2026 SET rent_status = ? WHERE id = ?";
            ...
            if ($stmt) {
                ...
                if ($stmt->affected_rows > 0) {  
                    ...
                    header("Location: admin_education_department_record_borrow_toga_school_year_2026.php"); // Adjust to your main page
                } else {
                    echo "<script>
