...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT student_name FROM scire_2029  WHERE student_name = '$student_name'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>window.location.href = "admin_scire_year_2029.php";</script>';
    } else {
        // Insert data into the database
        $sql = "INSERT INTO scire_2029 (year, student_name, section) 
