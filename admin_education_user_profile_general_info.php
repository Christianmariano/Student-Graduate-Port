...
<body>
    ...
    <ul>
        ...
        <div class="main">
            ...
            <!-- ================ Profile Form ================= -->
            <p style="margin-left:3%; margin-bottom:3%; font-size:40px">Department of Education</p>
            <center>
            ...
            <div class="profile-container">
                <div class="profile-form">
                    <form method="POST" action="admin_education_update_profile.php" enctype="multipart/form-data">
