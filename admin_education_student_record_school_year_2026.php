...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $query = "SELECT * FROM education_student_record_school_year_2026 WHERE fourth_year_id LIKE '%$search%' OR fourth_year_name LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);

                                if (mysqli_num_rows($query_run) > 0) {
                                    foreach ($query_run as $row) {
                                        echo "<tr>
                                            <td>{$row['fourth_year_id']}</td>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_record_school_year_2026 WHERE student_id LIKE '%$search%' OR student_name LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM scire_2026 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM guild_math_2026 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_activity_attendance_school_year_2026 WHERE student_id LIKE '%$search%' OR fullname LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br><br><br>
                        <p>Education Student Record School Year 2026-2027</p>
                        <br><br><br>
                    </div>
                        <!-------------------------------- Fourth Year -------------------------------->
                    ...
                    <div class="invoice-details">
                        ...
                        <div class="invoice-details">
                            ...
                            <div class="invoice-details">
                                <?php
                                    // SQL query to select data
                                    $sql = "SELECT * FROM guild_math_2026";
                                    $result = $link->query($sql);
