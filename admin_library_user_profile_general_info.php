...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <!-- ================ Profile Form ================= -->
            <p style="margin-left:3%; margin-bottom:3%; font-size:40px">Library</p>
            <center>
            ...
            <div class="profile-container">
                ...
                <div class="profile-form">
                    <form method="POST" action="admin_library_update_profile.php" enctype="multipart/form-data">
                        <label >Username</label>
                        <input type="text" name="username" value="<?php echo htmlspecialchars($username); ?>">
                        <label >Fullname</label>
                        <input type="text" name="fullname" value="<?php echo htmlspecialchars($user['fullname']); ?>">
                        <label >Gmail</label>
                        <input type="email" name="gmail" value="<?php echo htmlspecialchars($user['gmail']); ?>">
                        <label >Phone</label>
