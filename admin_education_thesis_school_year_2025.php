        ...
        <div class="main">
                ...
                <div class="document" style="width:150%">
                    ...
                    <div style="width: 160px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_education_thesis_school_year_2024.php">2024-2025</option>
                            <option value="admin_education_thesis_school_year_2025.php">2025-2026</option>
                            <option value="admin_education_thesis_school_year_2026.php">2026-2027</option>
                            <option value="admin_education_thesis_school_year_2027.php">2027-2028</option>
                            <option value="admin_education_thesis_school_year_2028.php">2028-2029</option>
                            <option value="admin_education_thesis_school_year_2029.php">2029-2030</option>
                        </select>
                    </div>
                            ...
                            <?php 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="education_update_thesis_status_school_year_2025.php" method="POST" style="display: inline;">
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['student_name']); ?>', '<?php echo htmlspecialchars($row['major']); ?>')">Edit</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="education_update_thesis_info_school_year_2025.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="education_thesis_delete_student_school_year_2025.php" method="POST">
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_record_thesis_function_school_year_2025.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student Thesis Status Record School Year 2025-2026</p>
                        <br>
                    </div>
...
function openModal(id, studentName, major) {
