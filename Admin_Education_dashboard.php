...
// Fetch student data
$student_query = "SELECT * FROM education_student_record_school_year_2025";
$student_query_run = mysqli_query($link, $student_query);
...
<body>
    ...
    <div class="navigation">
        ...
        <div class="main">
            ...
            <div class="cardBox">
                <a href="admin_education_record_tree_planting_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Tree Planting</div>
                        </div>
                        <div class="iconBx">
                        <i class="fas fa-tree"></i>
                        </div>
                ...
                <a href="admin_education_record_ojt_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">OJT</div>
                        </div>
                        <div class="iconBx">
                        <i class="fas fa-briefcase"></i>
                        </div>
                ...
                <a href="admin_education_monitoring_library_borrow_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Student Borrow Book List</div>
                        </div>
                        <div class="iconBx">
                        <i class="fa-solid fas fa-book"></i>
                        </div>
                ...
                <a href="admin_education_department_graduation_fee_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Student Graduation Fee</div>
                        </div>
                        <div class="iconBx">
                ...
                <a href="admin_education_department_record_borrow_toga_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Student Rent Toga</div>
                        </div>
                        <div class="iconBx">
                ...
                <a href="admin_education_first_year_student_grade_record_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Student Grade Record</div>
                        </div>
                ...
                <a href="admin_education_student_record_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Student Record</div>
                        </div>
                ...
                <a href="admin_education_thesis_school_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Thesis</div>
                        </div>
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        <h2>Student Record Record</h2>
                        <a href="admin_education_student_record_school_year_2024.php" class="btn">View All</a>
                    </div>
                        <table style="margin-top:3%">
                            <thead>
                                <tr>
                                    <td class="centered-header">Student ID</td>
                                    <td class="centered-header">Student Name</td>
                                    <td class="centered-header">Graduation Fee</td>
                                    <td class="centered-header">Rent Toga Fee</td>
                                    <td class="centered-header">OJT Fee</td>
                                    <td class="centered-header">OJT Status</td>
                                    <td class="centered-header">Rent Toga Status</td>
                                    <td class="centered-header">Thesis Status</td>
                                    <td class="centered-header">Tree Planting Status</td>
                                </tr>
                            </thead>
                            <tbody>
                                   <?php
                                   ...
                                   if ($student_query_run->num_rows > 0) {
                                       while($row = $student_query_run->fetch_assoc()) {
                                           ?>
                                           <tr>
                                               ...
                                               <td><?php echo htmlspecialchars($row['ojt_status']); ?></td>
                                               <td><?php echo htmlspecialchars($row['rent_status']); ?></td>
                                               <td><?php echo htmlspecialchars($row['thesis_status']); ?></td>
                                               <td><?php echo htmlspecialchars($row['tree_planting_status']); ?></td>
                                           </tr>
                                           <?php
                                       }
                                   } else {
