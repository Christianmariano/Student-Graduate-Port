            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Information Technology Student Borrow Book List School Year 2025-2026</h2>
                            <!-- Search Form -->
            ...
            <!-- The Modal -->
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Library Information Technology Student Borrow Book List School Year 2025-2026</p>
                        <br>
                    </div>
