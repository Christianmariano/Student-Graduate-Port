...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM first_year_it_second_sem_student_record_school_year_2028") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM first_year_it_second_sem_student_record_school_year_2028 LIMIT $offset, $total_record_per_page";
// Result
        ...
        <div class="main">
            ...
            <div class="details">
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM first_year_it_second_sem_student_record_school_year_2028 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_first_year_student__second_sem_grade_status_school_year_2028.php" method="POST" style="display: inline;">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM first_year_it_second_sem_student_record_school_year_2028 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_first_year_student_info_second_sem_school_year_2028.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_first_year_second_sem_delete_student_school_year_2028.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_record_frist_year_second_sem_function_school_year_2028.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Information Technology First Year 2 Sem Grade Record School Year 2028</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM first_year_it_second_sem_student_record_school_year_2028";
