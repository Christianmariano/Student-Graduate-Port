...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT third_year_student_id FROM third_year_entrep_first_sem_student_record_school_year_2027  WHERE third_year_student_id = '$third_year_student_id'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>window.location.href = "admin_entrep_third_year_student_grade_year_2027.php";</script>';
    } else {
        // Insert data into the database
        $sql = "INSERT INTO  third_year_entrep_first_sem_student_record_school_year_2027 (third_year_student_id, third_year_student_name) 
