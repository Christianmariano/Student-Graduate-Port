            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>OJT Record School Year 2025-2026</h2>
                            <!-- Search Form -->
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    <td><?php echo htmlspecialchars($row['student_name']); ?></td>
                                        ...
                                        <td>
                                            <form action="education_update_ojt_status_school_year_2025.php" method="POST" style="display: inline;">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        ...
                        <h2>Edit Student Information</h2>
                            <form id="editRentTogaForm" method="POST" action="education_update_ojt_info_school_year_2025.php">
                ...
                <div class="file-list">
                 ...
                 <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student OJT Record School Year 2025-2026</p>
                        <br>
                    </div>
