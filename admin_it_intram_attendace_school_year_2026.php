...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM it_event_attendance_school_year_2026") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM it_event_attendance_school_year_2026 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM it_event_attendance_school_year_2026 WHERE student_id LIKE '%$search%' OR fullname LIKE '%$search%'";
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br><br><br>
                        <p>IT Intramural Attendance Record School Year 2026</p>
                        <br><br><br>
                    </div>
                    <div class="invoice-details">
                        <?php
                            // SQL query to select data
                            $sql = "SELECT * FROM it_event_attendance_school_year_2026";
