...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['third_year_student_id'])) {
    ...
    $query = "DELETE FROM third_year_entrep_first_sem_student_record_school_year_2026 WHERE third_year_student_id = '$third_year_student_id'";

    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_entrep_third_year_student_grade_year_2026.php'); // Adjust as necessary
        exit;
    } else {
