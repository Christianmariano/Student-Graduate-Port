...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM entrepreneurship_student_library_borrow_year_2030") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM entrepreneurship_student_library_borrow_year_2030 LIMIT $offset, $total_record_per_page";
// Result
    ...
    <div class="navigation">
            <ul>
                ...
                <li>
                    ...
                    <li>
                        <a href="Admin_library_dashboard.php">
                            <span class="icon">
                    ...
                    <li class="dropdown">
                        <a href="#">
                            ...
                            <span class="title">Student borrow Book List</span>
                        </a>
                        <div class="dropdown-content">
                            <a style="color: black" href="admin_fisheries_student_library_borrow_year_2025.php">Fiheries</a>
                            <a style="color: black" href="admin_education_student_library_borrow_year_2025.php">Education</a>
                            <a style="color: black" href="admin_it_student_library_borrow_year_2025.php">IT </a>
                            <a style="color: black" href="admin_entrepreneurship_student_library_borrow_year_2025.php">Entrepreneurship</a>
                        </div>
                    </li>
                    <li>
            ...
            <div class="topbar">
                ...
                <div class="user">
                    ...
                    <div class="dropdown-content_a">
                        <a href="admin_library_user_profile_general_info.php">General Info</a>
                        <a href="admin_library_change_password.php">Change Password</a>
                    </div>
                </div>
            </div>
            <p style="margin-left:3%; font-size:40px">Library</p>
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Entrepreneurship Student Borrow Book List School Year 2024-2025</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_entrepreneurship_student_library_borrow_year_2024.php">2024-2025</option>
                                <option value="admin_entrepreneurship_student_library_borrow_year_2025.php">2025-2026</option>
                                <option value="admin_entrepreneurship_student_library_borrow_year_2026.php">2026-2027</option>
                                <option value="admin_entrepreneurship_student_library_borrow_year_2027.php">2027-2028</option>
                                <option value="admin_entrepreneurship_student_library_borrow_year_2028.php">2028-2029</option>
                                <option value="admin_entrepreneurship_student_library_borrow_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>Student ID</th>
                                    <th>Student Name</th>
                                    <th>Date & Time Borrow Book</th>
                                    <th>Date & Time Return Book</th>
                                    <th>Student Borrow Book Status</th>
                                    <th>Action Student Borrow Book Status</th>
                                    <th>Action</th>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM entrepreneurship_student_library_borrow_year_2030 WHERE 
                                    student_name LIKE '%$search%' OR
                                    year_section LIKE '%$search%' OR 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['date_time_borrow']); ?></td>
                                        <td><?php echo htmlspecialchars($row['date_time_return']); ?></td>
                                        <td><?php echo htmlspecialchars($row['borrow_book_status']); ?></td>
                                        <td>
                                            <form action="entrepreneurship_update_borrow_book_status_school_year_2030.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="borrow_book_status" class="status-select" onchange="this.form.submit()">
                                                    <option value="Borrow" <?php echo ($row['borrow_book_status'] === 'Borrow') ? 'selected' : ''; ?>>Borrow</option>
                                                    <option value="Return" <?php echo ($row['borrow_book_status'] === 'Return') ? 'selected' : ''; ?>>Return</option>
                                                </select>
                                            </form>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['student_id']); ?>', '<?php echo htmlspecialchars($row['student_name']); ?>', '<?php echo htmlspecialchars($row['date_time_borrow']); ?>', '<?php echo htmlspecialchars($row['date_time_return']); ?>')">Edit</a>
                                            <a href="javascript:void(0)" onclick="openDeleteModal('<?php echo htmlspecialchars($row['student_id']); ?>')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM entrepreneurship_student_library_borrow_year_2030 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="entrepreneurship_update_borrow_book_school_year_2030.php">
                                <input type="hidden" id="modal_id" name="id">
                                <label for="first_year_student_id">Student ID</label>
                                <input type="text" id="modal_student_id" name="student_id"><br>
                                <label for="student_name">Student Name</label>
                                <input type="text" id="modal_student_name" name="student_name"><br>
                                <label for="Date & Time Borrow Book">Date & Time Borrow Book</label>
                                <input type="datetime-local" id="modal_date_time_borrow" name="date_time_borrow"><br>
                                <label for="Date & Time Return Book">Date & Time Return Book</label>
                                <input type="datetime-local" id="modal_date_time_return" name="date_time_return"><br>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="entrepreneurship_borrow_book_delete_student_school_year_2030.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Entrepreneurship_borrow_book_function_school_year_2030.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                                    ...
                                    <label for="Date & Time Borrow Book">Date & Time Borrow Book</label>
                                    <input type="datetime-local" name="date_time_borrow" id="date_time_borrow" required>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Library Entrepreneurship Student Borrow Book List School Year 2024-2025</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM entrepreneurship_student_library_borrow_year_2030";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<table border='1'>
                                        <tr>
                                            ...
                                            <th>Date & Time Borrow Book</th>
                                            <th>Date & Time Return Book</th>
                                            <th>Studetn Borrow Book Status</th>
                                        </tr>";
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr>
                                            <td>" . $row["student_id"]. "</td>
                                            <td>" . $row["student_name"]. "</td>
                                            <td>" . $row["date_time_borrow"]. "</td>
                                            <td>" . $row["date_time_return"]. "</td>
                                            <td>" . $row["borrow_book_status"]. "</td>
                                        </tr>";
                                }
                                echo "</table>";
                            } else {
...
function openModal(id, Studentname, Borrow, Return) {
    ...
    document.getElementById('modal_date_time_borrow').value = Borrow;
    document.getElementById('modal_date_time_return').value = Return;
}
