            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>OJT Record School Year 2029-2030</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 160px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_education_record_ojt_school_year_2024.php">2024-2025</option>
                            <option value="admin_education_record_ojt_school_year_2025.php">2025-2026</option>
                            <option value="admin_education_record_ojt_school_year_2026.php">2026-2027</option>
                            <option value="admin_education_record_ojt_school_year_2027.php">2027-2028</option>
                            <option value="admin_education_record_ojt_school_year_2028.php">2028-2029</option>
                            <option value="admin_education_record_ojt_school_year_2029.php">2029-2030</option>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    ...
                                    <td><?php echo htmlspecialchars($row['student_name']); ?></td>
                                        ...
                                        <td><?php echo htmlspecialchars($row['ojt_balance']); ?></td>
                                        <td><?php echo htmlspecialchars($row['ojt_fee_status']); ?></td>
                                        <td>
                                            <form action="education_update_ojt_status_school_year_2029.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="ojt_status" class="status-select" onchange="this.form.submit(); changeColor(this);">
                                                    <option >Select</option>
                                                    <option value="Not Completed" <?php echo ($row['ojt_status'] === 'Not Completed') ? 'selected' : ''; ?>>Not Completed</option>
                                                    <option value="Completed" <?php echo ($row['ojt_status'] === 'Completed') ? 'selected' : ''; ?>>Completed</option>
                                                </select>
                                            </form>
                                        </td>
                                        <!--
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['student_id']); ?>', '<?php echo htmlspecialchars($row['student_name']); ?>','<?php echo htmlspecialchars($row['major']); ?>' '<?php echo htmlspecialchars($row['ojt_fee']); ?>')">Edit</a>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        ...
                        <h2>Edit Student Information</h2>
                            <form id="editRentTogaForm" method="POST" action="education_update_ojt_info_school_year_2029.php">
                                ...
                                <label for="student_name">OJT Fee</label>
                                <input type="text" id="modal_ojt_fee" name="ojt_fee" ><br>
                                <label for="student_name">Mjor</label>
                ...
                <div class="file-list">
                 ...
                 <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student OJT Record School Year 2029-2030</p>
                        <br>
                    </div>
...
function openModal(id, studentId, studentName, major, studentOJT) {
    ...
    document.getElementById('modal_ojt_fee').value = studentOJT;
...
<script>
    ...
    // Initialize the dropdown with its selected value on page load
