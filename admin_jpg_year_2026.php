...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM jpg_2026") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM jpg_2026 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>JPG Record School Year 2026-2027</h2>
                            <!-- Search Form -->
                    ...
                    <table>
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM jpg_2026 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_jpg_contribution_year_2026.php" method="POST" style="display: inline;">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM jpg_2026 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_jpg_year_2026.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_jpg_delete_student_school_year_2026.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_jpg_year_2026.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>JPG Record School Year 2026-2027</p>
                        <br>
                    </div>
