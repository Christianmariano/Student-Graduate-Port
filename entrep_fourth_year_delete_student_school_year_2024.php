...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['fourth_year_id'])) {
    ...
    $query = "DELETE FROM entrepreneurship_student_record_school_year_2030 WHERE fourth_year_id = '$fourth_year_id'";
    
    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_entrep_fourth_year_student_grade_year_2024.php'); // Adjust as necessary
        exit;
    } else {
