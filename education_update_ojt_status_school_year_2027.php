...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $ojt_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2027 SET ojt_status = :ojt_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_record_ojt_school_year_2027.php"); // Adjust to your main page
        } else {
