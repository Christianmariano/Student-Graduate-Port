        ...
        <div class="main">
            ...
            <div class="details">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php 
                                ...
                                $query = "SELECT * FROM education_student_activity_attendance_school_year_2029 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="education_update_student_activity_year_2029.php" method="POST" style="display: inline;">
                                        ...
                                        <td>
                                            <form action="education_update_student_activity_uswag_year_2029.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                        ...
                                        <td>
                                            <form action="education_update_student_activity_christmass_party_year_2029.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                        ...
                                        <td>
                                            <form action="education_update_student_activity_status_year_2029.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM education_student_activity_attendance_school_year_2029 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="education_update_student_activity_info_year_2029.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="education_student_activity_delete_student_school_year_2029.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_student_activity_year_2029.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student Activity Record School Year 2029-2030</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM education_student_activity_attendance_school_year_2029";
