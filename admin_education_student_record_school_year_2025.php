                ...
                <div class="document" style="width:150%">
                    ...
                    <div style="width: 160px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_education_student_record_school_year_2024.php">2024-2025</option>
                            <option value="admin_education_student_record_school_year_2025.php">2025-2026</option>
                            <option value="admin_education_student_record_school_year_2026.php">2026-2027</option>
                            <option value="admin_education_student_record_school_year_2027.php">2027-2028</option>
                            <option value="admin_education_student_record_school_year_2028.php">2028-2029</option>
                            <option value="admin_education_student_record_school_year_2029.php">2029-2030</option>
                        </select>
                    </div>
...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $query = "SELECT * FROM education_student_record_school_year_2025 WHERE fourth_year_id LIKE '%$search%' OR fourth_year_name LIKE '%$search%'";
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_record_school_year_2025 WHERE student_id LIKE '%$search%' OR student_name LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <!-------------------------------- Organization -------------------------------->
                    <br>
                    <center><h2>Organization/Guild</h2></center>
                    <h2>SCIRE</h2>
                    <table border="1">
                        <thead>
                            <tr>
...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM scire_2025 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
...
$conn = mysqli_connect("sql105.infinityfree.com", "if0_37740098", "5oAh2dTDTzZBcT", "if0_37740098_graduate_portal");
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM guild_math_2025 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_activity_attendance_school_year_2025 WHERE student_id LIKE '%$search%' OR fullname LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br><br><br>
                        <p>Education Student Record School Year 2025-2026</p>
                        <br><br><br>
                    </div>
                        <!-------------------------------- Fourth Year -------------------------------->
                    ...
                    <div class="invoice-details">
                        ...
                        <div class="invoice-details">
                            ...
                            <div class="invoice-details">
                                <?php
                                    // SQL query to select data
                                    $sql = "SELECT * FROM guild_math_2025";
                                    $result = $link->query($sql);
