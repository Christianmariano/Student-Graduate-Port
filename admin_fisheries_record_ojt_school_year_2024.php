                ...
                <div class="document" style="width:150%">
                    ...
                    <div style="width: 160px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_fisheries_record_ojt_school_year_2024.php">2024-2025</option>
                            <option value="admin_fisheries_record_ojt_school_year_2025.php">2025-2026</option>
                            <option value="admin_fisheries_record_ojt_school_year_2026.php">2026-2027</option>
                            <option value="admin_fisheries_record_ojt_school_year_2027.php">2027-2028</option>
                            <option value="admin_fisheries_record_ojt_school_year_2028.php">2028-2029</option>
                            <option value="admin_fisheries_record_ojt_school_year_2029.php">2029-2030</option>
                        </select>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM fisheries_student_record_school_year_2030 WHERE 
                                    ...
                                    ojt_amount_paid LIKE '%$search%' LIKE '%$search%'";
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="fisheries_update_ojt_status_school_year_2024.php" method="POST" style="display: inline;">
                                        ...
                                        <!--
                                        <td>
                                            <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['student_id']); ?>', '<?php echo htmlspecialchars($row['student_name']); ?>', '<?php echo htmlspecialchars($row['ojt_fee']); ?>')">Edit</a>
            ...
            <div id="myModal" class="modal">
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Fisheries Student OJT Record School Year 2024-2025</p>
                        <br>
                    </div>
...
function openModal(id, studentId, studentName, studentOJT) {
