...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $tree_planting_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2030 SET tree_planting_status = :tree_planting_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_record_tree_planting_school_year_2024.php"); // Adjust to your main page
        } else {
