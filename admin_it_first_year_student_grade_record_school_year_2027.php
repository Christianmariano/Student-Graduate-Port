...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM first_year_it_first_sem_student_record_school_year_2027") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM first_year_it_first_sem_student_record_school_year_2027 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>First Year Grade Record School Year 2027-2028</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_it_first_year_student_grade_record_school_year_2025.php">2025-2026</option>
                                <option value="admin_it_first_year_student_grade_record_school_year_2026.php">2026-2027</option>
                                <option value="admin_it_first_year_student_grade_record_school_year_2027.php">2027-2028</option>
                                <option value="admin_it_first_year_student_grade_record_school_year_2028.php">2028-2029</option>
                                <option value="admin_it_first_year_student_grade_record_school_year_2029.php">2029-2030</option>
                                <option value="admin_it_first_year_student_grade_record_school_year_2030.php">2030-2031</option>
                            </select>
                        </div>
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM first_year_it_first_sem_student_record_school_year_2027 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_first_year_student_grade_status_school_year_2027.php" method="POST" style="display: inline;">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_first_year_student_info_school_year_2027.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_first_year_delete_student_school_year_2027.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_record_frist_year_first_sem_function_school_year_2027.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Information Technology First Year 1 Sem Grade Record School Year 2027</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM first_year_it_first_sem_student_record_school_year_2027";
