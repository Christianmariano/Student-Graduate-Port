...
/*css prin*/
        ...
        * {
        ...
        /*change color option */
        .not-completed {
            background-color: red; /* Light red for Not Completed */
            color: white;
        }
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Fourth Year Grade Record School Year 2027-2028</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_education_fourth_year_student_grade_year_2024.php">2024-2025</option>
                                <option value="admin_education_fourth_year_student_grade_year_2025.php">2025-2026</option>
                                <option value="admin_education_fourth_year_student_grade_year_2026.php">2026-2027</option>
                                <option value="admin_education_fourth_year_student_grade_year_2027.php">2027-2028</option>
                                <option value="admin_education_fourth_year_student_grade_year_2028.php">2028-2027</option>
                                <option value="admin_education_fourth_year_student_grade_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <table>
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM education_student_record_school_year_2027 WHERE 
                                    fourth_year_name LIKE '%$search%' OR
                                    fourth_year_student_grade_first_sem_status LIKE '%$search%' OR 
                                    fourth_year_id LIKE '%$search%'";
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($row['fourth_year_name']); ?></td>
                                        <td><?php echo htmlspecialchars($row['fourth_major']); ?></td>
                                        
                                        <td>
                                            <form action="education_update_fourth_year_student_grade_status_school_year_2027.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="fourth_year_student_grade_first_sem_status" class="status-select" onchange="this.form.submit(); changeColor(this);">
                                                    <option >Select</option>
                                                    <option value="Not Completed" <?php echo ($row['fourth_year_student_grade_first_sem_status'] === 'Not Completed') ? 'selected' : ''; ?>>Not Completed</option>
                                                    <option value="Completed" <?php echo ($row['fourth_year_student_grade_first_sem_status'] === 'Completed') ? 'selected' : ''; ?>>Completed</option>
                                                </select>
                                            </form>
                                        </td>
                                        <td>
                                        <a href="javascript:void(0)" onclick="openModal('<?php echo htmlspecialchars($row['id']); ?>', '<?php echo htmlspecialchars($row['fourth_year_name']); ?>', '<?php echo htmlspecialchars($row['fourth_major']); ?>')">Edit</a>
                                            <a href="javascript:void(0)" onclick="openDeleteModal('<?php echo htmlspecialchars($row['fourth_year_id']); ?>')">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        ...
                        <h2>Edit Student Information</h2>
                            <form id="editRentTogaForm" method="POST" action="education_update_fourth_year_student_info_school_year_2027.php">
                                <input type="hidden" id="modal_id" name="id">
                                <label for="student_name">Student Name</label>
                                <input type="text" id="modal_fourth_year_name" name="fourth_year_name"><br>
                                <label for="fourth_major">Major</label>
                                <input type="text" id="modal_fourth_major" name="fourth_major"><br>
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="education_fourth_year_delete_student_school_year_2027.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_record_fourth_year_first_sem_function_school_year_2027.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                                    ...
                                    <label for="student_name">Student Name</label>
                                    <input type="text" name="fourth_year_name" id="fourth_year_name" required>

                                    <label for="fourth_major">Major</label>
                                    <input type="text" name="fourth_major" id="fourth_major">
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Fourth Year 1 Sem Grade Record School Year 2027-2028</p>
                        <br>
                    </div>
...
function openModal(id, Firstsem, fourth_major) {
    document.getElementById('first_year_student_grade_status_TogaModal').style.display = 'block';
    document.getElementById('modal_id').value = id;
    document.getElementById('modal_fourth_year_name').value = Firstsem;
    document.getElementById('modal_fourth_major').value = fourth_major;
}
...
<script>
    // Function to handle color changes based on selection
    function changeColor(selectElement) {
        const value = selectElement.value;

        // Remove any existing classes
        selectElement.classList.remove('not-completed', 'completed');

        // Add the corresponding class based on the selected value
        if (value === 'Not Completed') {
            selectElement.classList.add('not-completed');
        } else if (value === 'Completed') {
            selectElement.classList.add('completed');
        }
    }

    // Initialize the dropdown color change when the page loads
