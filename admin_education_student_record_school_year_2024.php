            ...
            <div class="details">
                <div class="document" style="width:150%">
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM education_student_record_school_year_2030 WHERE fourth_year_id LIKE '%$search%' OR fourth_year_name LIKE '%$search%'";
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_record_school_year_2030 WHERE student_id LIKE '%$search%' OR student_name LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM scire_2030 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $search = isset($_GET['search']) ? $_GET['search'] : '';
                                $query = "SELECT * FROM guild_math_2030 WHERE student_name LIKE '%$search%' OR year LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM education_student_activity_attendance_school_year_2024 WHERE student_id LIKE '%$search%' OR fullname LIKE '%$search%'";
                                $query_run = mysqli_query($conn, $query);
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br><br><br>
                        <p>Education Student Record School Year 2024-2025</p>
                        <br><br><br>
                    </div>
                        <!-------------------------------- Fourth Year -------------------------------->
                    ...
                    <div class="invoice-details">
                        ...
                        <div class="invoice-details">
                            ...
                            <div class="invoice-details">
                                <?php
                                    // SQL query to select data
                                    $sql = "SELECT * FROM guild_math_2030";
                                    $result = $link->query($sql);
