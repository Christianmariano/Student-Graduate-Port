...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $fourth_major = mysqli_real_escape_string($link, trim($_POST['fourth_major']));
        ...
        $sql = "INSERT INTO education_student_record_school_year_2029 (fourth_year_name, fourth_major) 
                VALUES ('$fourth_year_name', '$fourth_major')";

        if (mysqli_query($link, $sql)) {
            echo '<script>alert("Record added successfully.");</script>';
            echo '<script>window.location.href = "admin_education_fourth_year_student_grade_year_2029.php";</script>';
        } else {
