...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['second_year_student_id_second_sem'])) {
    ...
    $query = "DELETE FROM second_year_entrep_second_sem_student_record_school_year_2030 WHERE second_year_student_id_second_sem = '$second_year_student_id_second_sem'";

    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_entrep_second_year_student_second_sem_grade_record_school_year_2030.php'); // Adjust as necessary
        exit;
    } else {
