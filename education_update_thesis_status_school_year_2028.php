...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $thesis_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2028 SET thesis_status = :thesis_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_thesis_school_year_2028.php"); // Adjust to your main page
        } else {
