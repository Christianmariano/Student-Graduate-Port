...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['second_year_student_id_second_sem'])) {
    ...
    $query = "DELETE FROM second_year_education_second_sem_student_record_school_year_2029 WHERE second_year_student_id_second_sem = '$second_year_student_id_second_sem'";
