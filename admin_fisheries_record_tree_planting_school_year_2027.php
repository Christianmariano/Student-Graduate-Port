        ...
        <div class="main">
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Tree Planting Record School Year 2027-2028</h2>
                            <!-- Search Form -->
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="fisheries_update_tree_planting_status_school_year_2027.php" method="POST" style="display: inline;">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="fisheries_update_tree_planting_info_school_year_2027.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="fisheries_tree_planting_delete_student_school_year_2027.php" method="POST">
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Fisheries_record_tree_planting_function_school_year_2027.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Fisheries Student Tree Planting Record School Year 2027-2028</p>
                        <br>
                    </div>
