...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM it_student_library_borrow_year_2028") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM it_student_library_borrow_year_2028 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>IT Student Borrow Book List School Year 2028-2029</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 150px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_it_student_library_borrow_year_2024.php">2024-2025</option>
                                <option value="admin_it_student_library_borrow_year_2025.php">2025-2026</option>
                                <option value="admin_it_student_library_borrow_year_2026.php">2026-2027</option>
                                <option value="admin_it_student_library_borrow_year_2027.php">2027-2028</option>
                                <option value="admin_it_student_library_borrow_year_2028.php">2028-2029</option>
                                <option value="admin_it_student_library_borrow_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM it_student_library_borrow_year_2028 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_borrow_book_status_school_year_2028.php" method="POST" style="display: inline;">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM it_student_library_borrow_year_2028 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_borrow_book_school_year_2028.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_borrow_book_delete_student_school_year_2028.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_borrow_book_function_school_year_2028.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Library IT Student Borrow Book List School Year 2028-2029</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM it_student_library_borrow_year_2028";
