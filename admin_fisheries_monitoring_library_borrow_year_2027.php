...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM fisheries_student_library_borrow_year_2027") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM fisheries_student_library_borrow_year_2027 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Fisheries Student Borrow Book List School Year 2027-2028</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_fisheries_monitoring_library_borrow_year_2024.php">2024-2025</option>
                                <option value="admin_fisheries_monitoring_library_borrow_year_2025.php">2025-2026</option>
                                <option value="admin_fisheries_monitoring_library_borrow_year_2026.php">2026-2027</option>
                                <option value="admin_fisheries_monitoring_library_borrow_year_2027.php">2027-2028</option>
                                <option value="admin_fisheries_monitoring_library_borrow_year_2028.php">2028-2029</option>
                                <option value="admin_fisheries_monitoring_library_borrow_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM fisheries_student_library_borrow_year_2027 WHERE 
            ...
            <!-- The Modal -->
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Library Fisheries Student Borrow Book List School Year 2027-2028</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM fisheries_student_library_borrow_year_2027";
