        ...
        <div class="main">
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Education Student Record Rent Toga School Year 2028-2029</h2>
                            <!-- Search Form -->
                        <div class="search-container">
                            <form method="GET" action="">
                                ...
                                <!--<div class="form-container_export">
                                    <form  method="POST">
                                        <a href="education_rental_toga_school_year_2028_export_data.php">
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="education_cashier_update_status_payment_school_year_2028.php" method="POST" style="display: inline;">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="education_update_rent_toga_info_school_year_2028.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="rent_toga_education_delete_student_school_year_2028.php" method="POST">
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_record_borrow_toga_school_year_2028_function.php" enctype="multipart/form-data">
                                    <center>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Education Student Rent Toga Record School Year 2028-2029</p>
                        <br>
                    </div>
