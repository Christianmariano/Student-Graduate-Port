...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $ojt_fee_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2028 SET ojt_fee_status = :ojt_fee_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_cashier_education_department_ojt_fee_school_year_2028.php"); // Adjust to your main page
        } else {
