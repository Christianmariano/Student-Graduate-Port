...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM third_year_it_summer_class_student_record_school_year_2029") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2029 LIMIT $offset, $total_record_per_page";
// Result
        ...
        <div class="main">
            ...
            <div class="details">
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2029 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_third_year_summer_class_student_grade_status_school_year_2029.php" method="POST" style="display: inline;">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2029 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_summer_class_student_info_school_year_2029.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_summer_class_delete_student_school_year_2029.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_record_summer_class_function_school_year_2029.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Information Technology Summer Class Grade Record School Year 2029</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM third_year_it_summer_class_student_record_school_year_2029";
