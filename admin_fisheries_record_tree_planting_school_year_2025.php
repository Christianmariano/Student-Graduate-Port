        ...
        <div class="main">
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Tree Planting Record School Year 2025-2026</h2>
                            <!-- Search Form -->
                    ...
                    <div style="width: 160px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_fisheries_record_tree_planting_school_year_2024.php">2024-2025</option>
                            <option value="admin_fisheries_record_tree_planting_school_year_2025.php">2025-2026</option>
                            <option value="admin_fisheries_record_tree_planting_school_year_2026.php">2026-2027</option>
                            <option value="admin_fisheries_record_tree_planting_school_year_2027.php">2027-2028</option>
                            <option value="admin_fisheries_record_tree_planting_school_year_2028.php">2028-2029</option>
                            <option value="admin_fisheries_record_tree_planting_school_year_2029.php">2029-2030</option>
                        </select>
                    </div>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="fisheries_update_tree_planting_status_school_year_2025.php" method="POST" style="display: inline;">
                                                <input type="hidden" name="id" value="<?php echo htmlspecialchars($row['id']); ?>">
                                                <select name="tree_planting_status" class="status-select" onchange="this.form.submit(); changeColor(this)">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="fisheries_update_tree_planting_info_school_year_2025.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="fisheries_tree_planting_delete_student_school_year_2025.php" method="POST">
            ...
            <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Fisheries_record_tree_planting_function_school_year_2025.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <p>Esastern Visayas State University</p>
                        <br>
                        <p>Fisheries Student Tree Planting Record School Year 2025-2026</p>
                        <br>
                    </div>
