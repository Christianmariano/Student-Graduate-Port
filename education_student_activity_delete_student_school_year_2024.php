...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    $query = "DELETE FROM education_student_activity_attendance_school_year_2024 WHERE id = '$id'";
    
    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_education_student_activity_attendace_school_year_2024.php'); // Adjust as necessary
        exit;
    } else {
