...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $Intramural) {
        ...
        $sql = 'UPDATE education_student_activity_attendance_school_year_2029 SET Intramural = :Intramural WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_student_activity_school_year_2029.php"); // Adjust to your main page
        } else {
