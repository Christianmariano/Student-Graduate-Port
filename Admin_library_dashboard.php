...
<body>
    ...
    <div class="navigation">
                ...
                <li>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a style="color: black" href="admin_fisheries_student_library_borrow_year_2024.php">Fiheries</a>
                            <a style="color: black" href="admin_education_student_library_borrow_year_2030.php">Education</a>
                            <a style="color: black" href="admin_it_student_library_borrow_year_2024.php">IT </a>
        ...
        <div class="main">
            ...
            <div class="cardBox">
                <a href="admin_education_student_library_borrow_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Education Student borrow Book List</div>
                        </div>
                ...
                <a href="admin_it_student_library_borrow_year_2024.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">IT Student borrow Book List</div>
                        </div>
                        <div class="iconBx" style="color: black; margin-left: 5px">
                        <i class="fa-solid fa-book"></i>
                        </div>
                ...
                <a href="admin_entrepreneurship_student_library_borrow_year_2025.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Entrepreneurship Student borrow Book List</div>
                        </div>
                        <div class="iconBx" style="color: black; margin-left: 5px">
                        <i class="fa-solid fa-book"></i>
                        </div>
                ...
                <a href="admin_fisheries_student_library_borrow_year_2025.php" class="card-link">
                    <div class="card">
                        <div>
                            <div class="cardName">Fisheries Student borrow Book List</div>
                        </div>
                        <div class="iconBx" style="color: black; margin-left: 5px">
                        <i class="fa-solid fa-book"></i>
                        </div>
