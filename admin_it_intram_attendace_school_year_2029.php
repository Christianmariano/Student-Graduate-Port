...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM it_event_attendance_school_year_2029") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM it_event_attendance_school_year_2029 LIMIT $offset, $total_record_per_page";
// Result
    ...
    <ul>
            <div class="nav_sidebar">
                ...
                <li>
                    ...
                    <li>
                        <a href="admin_it_intram_attendace_school_year_2025.php">
                            <span class="icon">
                    ...
                    <li class="dropdown">
                        <a href="admin_it_uswag_attendace_school_year_2025.php">
                            <span class="icon">
                            <i class="fa-solid fas fa-file-pen"></i>
                            </span>
                    ...
                    <li class="dropdown">
                        <a href="admin_it_christmass_party_attendace_school_year_2025.php">
                            <span class="icon">
                            <i class="fa-solid fas fa-file-pen"></i>
                            </span>
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    ...
                    <div style="width: 150px; foat:right">
                        <select name="" id="" onchange="window.location.href=this.value;">
                            ...
                            <option value="admin_it_intram_attendace_school_year_2025.php">2025</option>
                            <option value="admin_it_intram_attendace_school_year_2026.php">2026</option>
                            <option value="admin_it_intram_attendace_school_year_2027.php">2027</option>
                            <option value="admin_it_intram_attendace_school_year_2028.php">2028</option>
                            <option value="admin_it_intram_attendace_school_year_2029.php">2029</option>
                            <option value="admin_it_intram_attendace_school_year_2030.php">2030</option>
                        </select>
                    </div>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <?php
                                ...
                                $query = "SELECT * FROM it_event_attendance_school_year_2029 WHERE student_id LIKE '%$search%' OR fullname LIKE '%$search%'";
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br><br><br>
                        <p>IT Intramural Attendance Record School Year 2029</p>
                        <br><br><br>
                    </div>
                    <div class="invoice-details">
                        <?php
                            // SQL query to select data
                            $sql = "SELECT * FROM it_event_attendance_school_year_2029";
