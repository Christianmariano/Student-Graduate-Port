...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM scire_2030") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM scire_2030 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>SCIRE Record School Year 2024-2025</h2>
                            <!-- Search Form -->
                    ...
                    <table>
                            ...
                            <?php 
                                ...
                                $query = "SELECT * FROM scire_2030 WHERE 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="education_update_scire_contribution_year_2024.php" method="POST" style="display: inline;">
                ...
                if (isset($_GET['edit_id'])) {
                    ...
                    $query = "SELECT * FROM scire_2030 WHERE id = '$id'";
                    $result = mysqli_query($link, $query);
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="education_update_scire_year_2024.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="education_scire_delete_student_school_year_2024.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="Education_scire_year_2024.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>SCIRE Record School Year 2024-2025</p>
                        <br>
                    </div>
