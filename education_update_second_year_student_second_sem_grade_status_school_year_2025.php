...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $second_year_student_grade_second_sem_status) {
        ...
        $sql = 'UPDATE second_year_education_second_sem_student_record_school_year_2025 SET second_year_student_grade_second_sem_status = :second_year_student_grade_second_sem_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_second_year_student_second_sem_grade_record_school_year_2025.php"); // Adjust to your main page
        } else {
