...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id && $fourth_year_student_grade_first_sem_status) {
        ...
        $sql = 'UPDATE education_student_record_school_year_2030 SET fourth_year_student_grade_first_sem_status = :fourth_year_student_grade_first_sem_status WHERE id = :id';
        ...
        if ($stmt->execute()) {
            ...
            header("Location: admin_education_fourth_year_student_grade_year_2024.php"); // Adjust to your main page
        } else {
