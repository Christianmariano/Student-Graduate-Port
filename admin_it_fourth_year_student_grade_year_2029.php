                    ...
                    <div style="width: 100%; overflow: hidden;">
                        <div style="float: left; width: 160px">
                            <select name="" id="" onchange="window.location.href=this.value;">
                                ...
                                <option value="admin_it_fourth_year_student_grade_year_2024.php">2024-2025</option>
                                <option value="admin_it_fourth_year_student_grade_year_2025.php">2025-2026</option>
                                <option value="admin_it_fourth_year_student_grade_year_2026.php">2026-2027</option>
                                <option value="admin_it_fourth_year_student_grade_year_2027.php">2027-2028</option>
                                <option value="admin_it_fourth_year_student_grade_year_2028.php">2028-2029</option>
                                <option value="admin_it_fourth_year_student_grade_year_2029.php">2029-2030</option>
                            </select>
                        </div>
                    </div>
                            ...
                            <?php 
                                ...
                                while ($row = mysqli_fetch_array($result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="it_update_fourth_year_student_grade_status_school_year_2029.php" method="POST" style="display: inline;">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="editRentTogaForm" method="POST" action="it_update_fourth_year_student_info_school_year_2029.php">
                ...
                <div class="modal-content">
                    ...
                    <div class="form-container">
                        <div class="student_status">
                            ...
                            <form id="deleteForm" action="it_fourth_year_delete_student_school_year_2029.php" method="POST">
            ...
            <!-- The Modal -->
                <div id="myModal" class="modal">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="form-container">
                            <div class="student_status">
                                <form method="POST" action="IT_record_fourth_year_first_sem_function_school_year_2029.php" enctype="multipart/form-data">
                                    <center>
                                        <p>Add Student</p>
                                    </center>
                                    <hr>
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Information Technology Fourth Year 1 Sem Grade Record School Year 2029-2030</p>
                        <br>
                    </div>
...
function openModal(id, studentId, Firstsem) {
    ...
    document.getElementById('modal_fourth_year_id').value = studentId;
