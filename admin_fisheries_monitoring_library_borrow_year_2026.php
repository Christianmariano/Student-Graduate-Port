...
$result_count = mysqli_query($link, "SELECT COUNT(*) as total_records FROM fisheries_student_library_borrow_year_2026") or die(mysqli_error($link));
// Total records
...
// Query string
$sql = "SELECT * FROM fisheries_student_library_borrow_year_2026 LIMIT $offset, $total_record_per_page";
// Result
            ...
            <div class="details">
                <div class="document" style="width:150%">
                    <div class="cardHeader">
                        <h2>Fisheries Student Borrow Book List School Year 2026-2027</h2>
                            <!-- Search Form -->
                    ...
                    <div style="margin-bottom:3%">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM fisheries_student_library_borrow_year_2026 WHERE 
            ...
            <!-- The Modal -->
                ...
                <div class="invoice-container">
                    <div class="invoice-header">
                        ...
                        <br>
                        <p>Library Fisheries Student Borrow Book List School Year 2026-2027</p>
                        <br>
                    </div>
                    ...
                    <div class="invoice-details">
                        <?php
                            ...
                            $sql = "SELECT * FROM fisheries_student_library_borrow_year_2026";
