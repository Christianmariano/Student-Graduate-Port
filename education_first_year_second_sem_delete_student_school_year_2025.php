...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['first_year_student_id_second_sem'])) {
    ...
    $query = "DELETE FROM first_year_education_second_sem_student_record_school_year_2025 WHERE first_year_student_id_second_sem = '$first_year_student_id_second_sem'";

    // Execute the query
    if (mysqli_query($link, $query)) {
        // Redirect to the main page or display a success message
        header('Location: admin_education_firt_year_student_second_sem_grade_record_school_year_2025.php'); // Adjust as necessary
        exit;
    } else {
