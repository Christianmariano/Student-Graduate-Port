...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $check_sql = "SELECT first_year_student_id FROM first_year_education_first_sem_student_record_school_year_2030 WHERE first_year_student_id = '$first_year_student_id'";
    ...
    if (mysqli_num_rows($check_result) > 0) {
        ...
        echo '<script>window.location.href = "admin_education_first_year_student_grade_record_school_year_2030.php";</script>';
    } else {
        // Insert data into the database
        $sql = "INSERT INTO first_year_education_first_sem_student_record_school_year_2030 (first_year_student_id, first_year_student_name) 
